...
def draw_footer(canvas, doc):
    ...
    canvas.drawString(MARGIN, 5.8 * mm, 'Durably Sustainability Claims Risk Scan — Methodology summary · v86')
...
def build_methodology_pdf():
    ...
    flow.append(Paragraph('Methodology summary &mdash; claim-risk screening &middot; v86 &middot; 19 August 2026', STY['sub']))
